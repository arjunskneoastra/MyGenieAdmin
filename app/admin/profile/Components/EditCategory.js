...
export default function EditCategory({ handleShowList }) {
    ...
    <div className="relative h-[calc(100vh-13rem)] rounded-2xl border border-gray-500 bg-white-default">
      <div className="flex items-center justify-between border-b px-8 py-6">
        <div className="flex">
          ...
          <p>
            <span className="underline text-blue-500 cursor-pointer" onClick={() => handleShowList()}>Categories</span>
            <span className="text-black !no-underline">/ {editId}</span>
          </p>
        </div>
      </div>
